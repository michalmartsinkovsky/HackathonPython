...
class Test_json_server_api:
    ...
    def test_get(self):
        ...
        Verify.verify_equal(result, 200, "Error- can't locate list of posts")
    ...
    def test_post(self):
        ...
        Verify.verify_equal(result, 201, "Error- can't add a new post")
    ...
    def test_delete(self):
        ...
        Verify.verify_equal(result, 200, "Error- deletion wasn't made")
